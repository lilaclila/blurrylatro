...
// this blurs the card art under the editions. foil needs this or it
// doesnt actually look blurry
#define BLUR_TAPS 3      // how many samples
#define BLUR_STEP 1.6    // how far apart they are
#define BLUR_SIGMA 2.0   // higher = softer
